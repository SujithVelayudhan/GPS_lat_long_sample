package com.example.sujith.gps_lat_long_sample;
...
public class GpsLocationActivity extends AppCompatActivity {
            ...
            public void onClick(View v)
            {
                ...
                locationListener = new LocationListener() {
                    ...
                    public void onLocationChanged(Location location)
                    {
                        ...
                        //Toast.makeText(GpsLocationActivity.this, "Direction: "+lat+"\n"+lon, Toast.LENGTH_SHORT).show();
    ...
    {
        latTextView=findViewById(R.id.latp);
        longTextView=findViewById(R.id.longp);
        getLocationButton=findViewById(R.id.loc_btnp);
    }
